...
class RenewalRouter:
    ...
    def __init__(self, config: dict, db_manager: DatabaseManager):
        ...
        _sectigo = ComodoIntegration(config, db_manager)
        ...
        self.integrations = {
            ...
            'sectigo': _sectigo,
            'comodo': _sectigo,   # legacy alias — same instance
    ...
    def suggest_ca_for_domain(self, domain: str) -> Dict:
        ...
        # Rank CAs based on domain characteristics (skip 'comodo' alias to avoid duplicates)
        for ca_name, integration in self.integrations.items():
            if ca_name == 'comodo':
                continue
            if integration.enabled:
